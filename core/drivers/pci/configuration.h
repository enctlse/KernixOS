...
// Порты для доступа к конфигурационному пространству
#define BUS_CFG_ADDR_PORT 0xCF8
#define BUS_CFG_DATA_PORT 0xCFC

// Смещения регистров в конфигурационном пространстве PCI
