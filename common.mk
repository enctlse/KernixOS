...
# Compiler Flags
COMMON_FLAGS += -I $(INCLUDE_DIR) -I $(SRC_DIR) -I core -I common -I . -ffreestanding -fno-stack-protector -fno-lto \
...
SYSCALL_SRCS = core/kernel/syscalls/syscalls.c \
               core/kernel/syscalls/syscall_entry.asm
SRC_DIR := core
USERSPACE_DIR = core/userspace
